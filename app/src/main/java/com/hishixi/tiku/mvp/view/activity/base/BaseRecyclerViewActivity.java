...
public abstract class BaseRecyclerViewActivity<T, V extends BaseView2, P extends Presenter> extends
        BaseActivity<V, P> implements PullRefreshLayout.OnRefreshListener,
    ...
    protected void onCreate(Bundle arg0) {
        super.onCreate(arg0);
        setContentView(R.layout.activity_base_pullrefresh_recyclerview_layout);
    }
