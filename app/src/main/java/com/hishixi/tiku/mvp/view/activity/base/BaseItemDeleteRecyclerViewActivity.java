...
import com.hishixi.tiku.custom.view.OnDeleteClickListener;
import com.hishixi.tiku.mvp.presenter.base.Presenter;
import com.hishixi.tiku.mvp.view.adapter.base.BaseDeleteRecyclerViewAdapter;
...
import static com.hishixi.tiku.R.id.swipeRefreshLayout;

/**
 * 带滑动删除的RecyclerView Activity
 * Created by seamus on 17/4/11 09:57
 */

public abstract class BaseItemDeleteRecyclerViewActivity<T, V extends BaseView2, P extends Presenter> extends
        BaseActivity<V, P> implements PullRefreshLayout.OnRefreshListener, OnDeleteClickListener{
    ...
    // 列表的适配器
    protected BaseDeleteRecyclerViewAdapter<T> mAdapter;
    // 是否设置没有数据的显示,默认为是
...
//    @BindView(R.id.fl_none_data)
//    FrameLayout mMainNoneDataLayout;
...
//        swipeRefreshLayout.setColorSchemeColors(new int[]);
        ...
        mRecyclerView.setOnDeleteListener(this);
