package com.hishixi.tiku.custom.recycler.adapter;
...
import com.hishixi.tiku.custom.recycler.BasicViewHolder;
import com.hishixi.tiku.custom.recycler.animators.IAnimation;
import com.hishixi.tiku.custom.recycler.animators.ViewHelper;
...
import com.hishixi.tiku.utils.PhoneUtil;
 ...
 * 重新封装Adapter
 */
public abstract class BasicAdapter<Item extends Serializable, VH extends
        BasicViewHolder> extends RecyclerView.Adapter<VH> {
     ...
     * @param item   item数据
     */
    public abstract void onBindItem(VH holder, Item item, int position) throws
            ParseException;
    ...
    public VH onCreateViewHolder(ViewGroup parent, int viewType) {
        mItemView = LayoutInflater.from(context).inflate(getLayoutId(viewType), parent,
                false);
