...
public class WheelView extends View {
    /**
     * Scrolling duration滚动的间隔
     */
    private static final int SCROLLING_DURATION = 400;

    /**
     * Minimum delta for scrolling 最小滚动的距离
     */
    private static final int MIN_DELTA_FOR_SCROLLING = 1;

    // /** Current value & label text color当前颜色 */
    // private static final int VALUE_TEXT_COLOR = 0xF0000000;
    //
    // /** Items text color文本的颜色 */
    // private static final int ITEMS_TEXT_COLOR = 0xFF000000;
    //

    /**
     * Top and bottom shadows colors底部和顶部的颜色
     */
    private static final int[] SHADOWS_COLORS = new int[]{0xFF111111, 0x00AAAAAA, 0x00AAAAAA};

    /**
     * Additional items height (is added to standard text item height)附加的高度
     */
    ...
    /**
     * Top and bottom items offset (to hide that) 底部和顶部的距离
     */
    private final int ITEM_OFFSET = TEXT_SIZE / 5;

    /**
     * Additional width for items layout 附加的宽度
     */
    ...
    /**
     * Left and right padding value 左右的距离
     */
    private static final int PADDING = 10;

    /**
     * Default count of visible items 默认显示的项目
     */
    ...
    // Label & background标签和文本
    private String label;
    private Drawable centerDrawable;

    // Shadows drawables阴影的材质
    ...
    private void initResourcesIfNecessary() {
        ...
        if (centerDrawable == null) {
            // 此处部分手机用自定义的背景无效，所以用透明图片表示
             centerDrawable = getContext().getResources().getDrawable(R.drawable.wheel_val);
//            centerDrawable = getContext().getResources().getDrawable(R.drawable.datepicker_bg);
        }
    ...
    private void drawValue(Canvas canvas) {
        ...
        valuePaint.setColor(Color.parseColor("#1b1b1b"));
    ...
    private void drawItems(Canvas canvas) {
        ...
        itemsPaint.setColor(Color.parseColor("#a5a5a5"));
