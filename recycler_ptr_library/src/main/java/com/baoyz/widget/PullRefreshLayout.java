...
public class PullRefreshLayout extends ViewGroup {
    ...
    public static final int STYLE_GIF = 5;
    ...
    private int mGifResId;//gif res id
    ...
    public PullRefreshLayout(Context context, AttributeSet attrs) {
        ...
        final int type = a.getInteger(R.styleable.refresh_PullRefreshLayout_refreshType,
                STYLE_MATERIAL);
        final int colorsId = a.getResourceId(R.styleable.refresh_PullRefreshLayout_refreshColors,
                0);
        ...
        if (colorsId > 0) {
            ...
            mColorSchemeColors = new int[]{Color.rgb(0xC9, 0x34, 0x37), Color.rgb(0x37, 0x5B,
                    0xF1), Color.rgb(0xF7, 0xD2, 0x3E), Color.rgb(0x34, 0xA3, 0x50)};
        }
    ...
    public void setRefreshStyle(int type) {
        ...
        switch (type) {
            ...
            case STYLE_SMARTISAN:
                ...
                break;
            case STYLE_GIF:
                mRefreshDrawable = new GifDrawable(getContext(), this, mGifResId);
                break;
            default:
...
// .EXACTLY), MeasureSpec.makeMeasureSpec(mRefreshViewHeight, MeasureSpec.EXACTLY));
    ...
    private void moveToStart(float interpolatedTime) {
        ...
        if(mScrollListener!=null)
        mScrollListener.onoffset2StartPosition();
    }
